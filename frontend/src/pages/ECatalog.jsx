      ...
      <div className="w-full justify-center flex p-4">
        <div className="w-full justify-center grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 space-y-10 gap-x-5">
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753786999/Catalog1_bejxqc.png'
              }
              alt=""
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753787005/Catalog2_ugkaep.png'
              }
              alt=""
              className="h-120 w-full"
            />
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753786999/catalog3_eujykx.png'
              }
              alt=""
              className="h-120 w-full"
            />
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753787001/Catalog4_srii2m.png'
              }
              alt=""
              className="h-120 w-full"
            />
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753787000/catalog5_iqlfg8.png'
              }
              alt=""
              className="h-120 w-full"
            />
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753787000/catalog6_kenssv.png'
              }
              alt=""
              className="h-120 w-full"
            />
          ...
          >
            <img
              src={
                'https://res.cloudinary.com/dnwppcwec/image/upload/v1753787002/catalog7_wi8ekz.png'
              }
              alt=""
              className="h-120 w-full"
            />
