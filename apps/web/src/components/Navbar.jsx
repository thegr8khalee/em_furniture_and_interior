...
const Navbar = () => {
  ...
  const hasPromoBar = !isPromoDismissed && promoItems.length > 0;
          ...
          {authUser ? (
            <>
              {isAdmin && (
                <a
                  href={ERP_URL}
                  className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-medium border border-neutral/20 text-neutral transition-colors hover:border-secondary hover:text-secondary"
                >
                  Operations
