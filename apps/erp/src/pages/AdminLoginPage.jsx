...
const AdminLoginPage = () => {
  ...
  return (
    <>
    {/* The storefront's SEO component carries public site metadata the console
        has no use for. The whole app is noindex via index.html; this only sets
        the tab title. Renders no visible markup, so the page is unchanged. */}
    <Helmet>
      <title>Admin Login — EM Furniture Operations</title>
