...
const EditCollection = () => {
  ...
  return (
    <AdminPageShell title="Edit Collection">
      <div className="bg-base-100 border border-base-200 p-6 w-full max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="form-control relative" ref={dropdownRef}>
            ...
            <div
              className="input input-bordered h-auto py-1 w-full rounded-none flex items-center justify-between cursor-pointer"
          ...
          <div className="form-control mt-6">
            <button
              type="submit"
              className="btn btn-primary w-full py-3.5 rounded-none font-body font-semibold tracking-wider uppercase shadow-md hover:shadow-lg transition duration-200"
